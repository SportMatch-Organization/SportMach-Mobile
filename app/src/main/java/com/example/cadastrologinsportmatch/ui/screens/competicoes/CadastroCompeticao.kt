package com.example.cadastrologinsportmatch.ui.screens.competicoes
...
import com.example.cadastrologinsportmatch.ui.components.CustomButton
import com.example.cadastrologinsportmatch.ui.components.CustomSelectField
import com.example.cadastrologinsportmatch.ui.components.CustomTextField
...
fun CadastroCompeticao(viewModel: CampeonatoViewModel = viewModel(), onNext: () -> Unit){
    val scrollState = rememberScrollState()
        Column(modifier = Modifier
            .fillMaxSize()
            .background(color = Color.White).padding(horizontal = 16.dp).verticalScroll(scrollState)) {
            ...
            CustomSelectField(
                ...
                onValueChange = {viewModel.esporteSelecionado = it}
            )
